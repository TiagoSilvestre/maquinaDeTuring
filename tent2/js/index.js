...
<td>( <select name="escreve:{{id}}:A"><option></option><option value="*">*</option><option value="vazio">&Oslash;</option><option value="a">A</option><option value="b">B</option><option value="inicial">&rarr;</option><option value="fim">F</option></select>, <input type="text" class="inpEst" name="proxEstado:{{id}}:A">,<select name="direcao:{{id}}:A"><option></option><option value="D">D</option><option value="E">E</option></select>)</td>
<td>( <select name="escreve:{{id}}:B"><option></option><option value="*">*</option><option value="vazio">&Oslash;</option><option value="a">A</option><option value="b">B</option><option value="inicial">&rarr;</option><option value="fim">F</option></select>, <input type="text" class="inpEst" name="proxEstado:{{id}}:B">,<select name="direcao:{{id}}:B"><option></option><option value="D">D</option><option value="E">E</option></select>)</td>
